...
namespace odb
{
  ...
  inline
  access::object_traits< ::RouteInfo >::id_type
  access::object_traits< ::RouteInfo >::
  ...
  inline
  void access::object_traits< ::RouteInfo >::
  ...
  inline
  access::object_traits< ::Route >::id_type
  ...
  inline
  void access::object_traits< ::Route >::
  callback (database& db, object_type& x, callback_event e)
  {
    ODB_POTENTIALLY_UNUSED (db);
    ODB_POTENTIALLY_UNUSED (x);
...
namespace odb
{
  ...
  inline
  access::object_traits_impl< ::RouteInfo, id_mssql >::root_traits::image_type&
  ...
  inline
  access::object_traits_impl< ::RouteInfo, id_mssql >::image_type*
  access::object_traits_impl< ::RouteInfo, id_mssql >::
  ...
  inline
  access::object_traits_impl< ::Route, id_mssql >::root_traits::image_type&
  ...
  inline
  access::object_traits_impl< ::Route, id_mssql >::image_type*
  access::object_traits_impl< ::Route, id_mssql >::
  clone_image (image_type& i)
  {
    details::unique_ptr<base_traits::image_type> p (
